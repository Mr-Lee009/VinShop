				...
				<div class="box-body">
					...
					<div class="form-group col-md-6">
						<label for="exampleInputEmail1">title</label> <input
							type="text" class="form-control" id="name-title"
							placeholder="Tên sản phẩm">
					</div>
					<div class="form-group col-md-6">
						<label for="exampleInputPassword1">link mp3</label> <input
							type="text" class="form-control" id="cost-linkmp3" placeholder="giá">
					</div>
					<div class="form-group col-md-12">
					...
					<div class="form-group col-md-12">
						<label for="exampleInputEmail1">Time test</label> <input type="text"
							class="form-control" id="time-test-edit" placeholder="đường dẫn ảnh">
					</div>
					<div class="form-group col-md-12">
						<b id="time-create-edit">User create:</b> <i></i> 
						<b id="time-update-edit">Time create:</b> <i></i> <br>
						<b id="update-by-edit">User create:</b> <i></i> 
						<b id="update-time-edit">Time update:</b> <i></i> <br>
					</div> 
				</div>
			</div>
			<div class="modal-footer">
