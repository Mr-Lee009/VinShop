...
<header class="main-header">
	...
	<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<span class="logo-lg"><b>Admin</b>VinSmart</span>
	</a>
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#"> Language
						<span class="caret"></span>
				</a>
					<ul class="dropdown-menu">
						<li role="presentation"><a role="menuitem"  href="./?lang=vi"><img src=""></a></li>
						<li role="presentation"><a role="menuitem"  href="./?lang=en"><img src=""></a></li>
						<li role="presentation"><a role="menuitem"  href="./?lang=ja"><img src=""></a></li>
					</ul>		
				</li>
